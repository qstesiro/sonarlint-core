...
public class SensorsExecutor {
    ...
    public SensorsExecutor(
        DefaultSensorContext context,
        SensorOptimizer sensorOptimizer,
        ProgressMonitor progress,
        Optional<List<Sensor>> sensors
    ) {
    ...
    private static void executeSensor(
        SensorContext context,
        Sensor sensor,
        DefaultSensorDescriptor descriptor
    ) {
        var sensorName = descriptor.name() != null
            ? descriptor.name()
            : describe(sensor);
